...
5. [함수 호출](#함수-호출)
   ...
   5-5.[참조에 의한 전달과 외부 상태의 변경](#참조에-의한-전달과-외부-상태의-변경)

6. [다양한 함수의 형태](#다양한-함수의-형태)

   6-1[즉시 실행 함수](#즉시-실행-함수)
...
함수 외부에서 전달받은 input을 이용한 함수 내부에서의 식 수행으로 언제나 동일한 output을 외부로 반환하는 것이다.
